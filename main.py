...
def adjust_image(image_path, output_path):
    ...
    # Convertir l'image en espace de couleur LAB pour un meilleur ajustement de la luminosité
    lab_image = cv2.cvtColor(image, cv2.COLOR_BGR2LAB)

    # Définir une zone de référence pour le "point blanc"
    white_ref_region = lab_image[0:10, 0:10]
